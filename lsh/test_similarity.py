...
class TimeSeriesLSHTest(unittest.TestCase):
    ...
    def test_series_shingles(self):
        ...
        series = self.series([
            0.5, -0.5, -0.5, 0.1, -0.9, 0.5, 0.4, 0.5, -0.5, 0.5, -0.5, -0.5,
            0.1
        ])
    ...
    def test_fit_query(self):
        ...
        query = self.series([
            0.6, 0.49, 0.3, 0.11, 0.91, 1.31, 0.41, 1.29, 0.49, 0.51, -0.49,
            -0.55, 0.12
        ])
        series0 = self.series([
            0.5, -0.5, -0.5, 0.1, -0.9, 1.3, 0.4, 1.3, -0.5, 0.5, -0.5, -0.5,
            0.1
        ])
        series1 = self.series([
            0.0, 0.0, -2.5, 1.13, 0.1, -0.7, 0.4, 1.3, -0.5, 0.5, -0.5, -0.5,
            0.1
        ])
        series2 = self.series([
            1.5, 0.0, 2.5, -1.13, 0.1, 0.0, 0.0, 1.3, 15.5, 10.0, 10.5, 3., 0.1
        ])
        series3 = self.series([
            1.5, 10.0, -2.5, -1.13, 0.1, 0.0, 0.0, 1.3, -15.5, -10.0, 10.5,
            0.5, 0.1
        ])
        series4 = self.series([
            1.5, 0.0, 2.5, -1.13, 0.1, 0.0, 0.0, 1.3, 15.5, -10.0, 10.5, -0.5,
            0.1
        ])
        series5 = self.series([
            1.5, 10.0, 12.5, -1.13, 0.1, 0.0, 0.0, 1.3, -15.5, 10.0, 10.5, 0.5,
            0.1
        ])
        series6 = self.series([
            1.5, 30.0, 2.5, -1.13, 0.1, 0.0, 0.0, 1.3, 15.5, -10.0, 10.5, 0.5,
            0.1
        ])
        input = [
            series0, series1, series2, series3, series4, series5, series6,
            query
        ]
        hash.fit(input)
